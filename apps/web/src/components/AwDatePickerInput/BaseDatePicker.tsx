...
import { buttonVariants, ButtonVariantType } from "../AwButton/variants";

export type BaseDatePickerPropsType = ComponentProps<typeof DayPicker> & {
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        DayButton: BaseDatePickerDayButton,
...
export const BaseDatePickerDayButton = ({
  className,
  day,
  modifiers,
  children,
